...
<div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
    ...
    <!-- KARTU 4: TIDAK HADIR -->
    <div class="bg-white p-6 rounded-xl shadow-sm border-b-4 border-red-500 transition-all hover:shadow-md">
        <div class="flex items-center justify-between">
            <div>
                <p class="text-[10px] text-gray-400 font-black uppercase tracking-widest">Tidak Hadir</p>
        ...
        <p class="text-[9px] text-gray-400 mt-2 italic">*Termasuk Izin, Sakit & Tanpa Keterangan</p>
    </div>
</div>
